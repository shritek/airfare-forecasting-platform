...
| --- | --- | --- |
| Live provider | terms, total-price semantics, identity fields, cost, limits, and reliability | SerpApi conditionally selected in ADR-0002; qualification gates remain |
